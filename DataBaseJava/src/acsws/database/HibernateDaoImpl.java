...
import acsws.database.pojos.Proposal;
...
public class HibernateDaoImpl {
	...
	public static Configuration getDefaultConfiguration() {
		...
		config.setProperty("hibernate.connection.url", "jdbc:hsqldb:file:hsqldb/acsws;shutdown=true"); //change this parameter to use another HSQLDB mode
